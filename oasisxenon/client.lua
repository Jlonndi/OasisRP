...
Citizen.CreateThread(function()	
	...
	while true do
		...
		if plate == nil then
			...
			ESX.TriggerServerCallback("oasisxenon:pobierz_swiatla", function(isPurchasable)
...
RegisterNetEvent("oasisxenon:otworz")
AddEventHandler("oasisxenon:otworz", function()
	...
	if IsPedInVehicle(ped, car, false) then
		...
		ESX.ShowAdvancedNotification('Installation', '', "~y~Installation complete, enjoy your new Xenons!", pic, 1)
	end
end)
...
RegisterNUICallback('save', function(data, cb)
	...
	TriggerServerEvent('oasisxenon:usun_swiatla')
	ESX.TriggerServerCallback("oasisxenon:zapisz_swiatla", function(isPurchasable)
		if isPurchasable then
			ESX.ShowAdvancedNotification('Installation complete', '', "~y~Enjoy your new Xenons!", pic, 1)
		else
			ESX.ShowAdvancedNotification('Error', '', "~r~Error Occured", pic, 1)
		end
