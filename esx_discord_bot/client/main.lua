        ...
        if NetworkIsPlayerActive(player) then
            ...
            if IsPedFatallyInjured(ped) and not isDead then
                ...
                if killer == ped or killer == 1 then
                    ...
                    TriggerServerEvent('esx:killerlog', 0, killertype, killer, { table.unpack(GetEntityCoords(ped)) })
                    hasBeenDead = true
                else
                    ...
                    TriggerServerEvent('esx:killerlog', 1, killerid, killer, {killertype=killertype, weaponhash = killerweapon, killerinveh=killerinvehicle, killervehseat=killervehicleseat, killervehname=killervehiclename, killerpos=table.unpack(GetEntityCoords(ped))})
                    hasBeenDead = true
                end
