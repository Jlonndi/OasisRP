local isCrafter, isInMarker, isInPublicMarker, hintIsShowed, HasAlreadyEnteredMarker = false, false, false, false, false
...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'lscartel' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function IsGradeBoss()
    if PlayerData ~= nil then
        ...
        if PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'shadow' then
            IsGradeBoss = true
        end
        return IsGradeBoss
    end
...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'crafter_outfit' then
        setClipset(playerPed, "MOVE_M@SWAGGER@")
      end
    else
      ...
      if job ~= 'citizen_wear' and job ~= 'crafter_outfit' then
        setClipset(playerPed, "MOVE_F@SWAGGER@")
      end
    end
  end)
end
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = _U('crafter_outfit'), value = 'crafter_outfit'},
    {label = _U('rank_outfit_1'), value = 'rank_outfit_1'},
   --[[ {label = _U('rank_outfit_2'), value = 'rank_outfit_2'},
    {label = _U('rank_outfit_3'), value = 'rank_outfit_3'},
    {label = _U('rank_outfit_4'), value = 'rank_outfit_4'},
    {label = _U('rank_outfit_5'), value = 'rank_outfit_5'},
    {label = _U('rank_outfit_6'), value = 'rank_outfit_6'},
    {label = _U('rank_outfit_7'), value = 'rank_outfit_7'},]]
  }
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
      ...
      if data.current.value == 'crafter_outfit' then
        setUniform(data.current.value, playerPed)
        isCrafter = true
      end

      if
        data.current.value == 'rank_outfit_1' or
        data.current.value == 'rank_outfit_2' or
        data.current.value == 'rank_outfit_3' or
        data.current.value == 'rank_outfit_4' or
        data.current.value == 'rank_outfit_5' or
        data.current.value == 'rank_outfit_6' or
        data.current.value == 'rank_outfit_7'
      then
        setUniform(data.current.value, playerPed)
      end
...
function OpenLockerMenu()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker', {
        ...
        if data.current.value == 'put_stock' then
           OpenPutLockerStocksMenu()
        end

        if data.current.value == 'get_stock' then
           OpenGetLockerStocksMenu()
        end
      end, function(data, menu)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'lscartel', vehicleProps)
        end, function(data, menu)
...
function OpenSocietyActionsMenu()
  ...
  if (isCrafter or IsGradeBoss()) then
    table.insert(elements, {label = _U('crafting'), value = 'menu_crafting'})
  end

  ESX.UI.Menu.CloseAll()

  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'lscartel_actions', {
      title    = _U('lscartel'),
      align    = 'top-left',
      elements = elements
    }, function(data, menu)
      ...
      --[[if data.current.value == 'menu_crafting' then
          ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'menu_crafting', {
                  ...
                  elements = {
                      ...
                      {label = _U('jackandcoke'),    value = 'jackandcoke'},
                      {label = _U('vodkaredbull'),   value = 'vodkaredbull'},
                      {label = _U('vodkajuice'),    value = 'vodkajuice'},
                      {label = _U('rumjuice'),     value = 'rumjuice'},
                      {label = _U('tequillalemonade'),        value = 'tequillalemonade'},
                      {label = _U('rumcoke'),      value = 'rumcoke'},
                      {label = _U('mojito'),        value = 'mojito'},
                      {label = _U('appetizer'),      value = 'appetizer'},
                      {label = _U('shotglass'),  value = 'shotglass'},
                      {label = _U('jagerredbull'),  value = 'jagerredbull'},
                  }}, function(data2, menu2)

                TriggerServerEvent('lscartel:craftingCoktails', data2.current.value)
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_lscartel', _U('billing'), amount)
        end
      else
...
function OpenGetStocksMenu()
  ESX.TriggerServerCallback('lscartel:getStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('lscartel:getStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenPutStocksMenu()
    ESX.TriggerServerCallback('lscartel:getPlayerInventory', function(inventory)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('lscartel:putStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetLockerStocksMenu()
  ESX.TriggerServerCallback('lscartel:getLockerStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker_menu', {
        title    = _U('lscartel_locker_stock'),
        elements = elements
      }, function(data, menu)

        local itemName = data.current.value

        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'locker_menu_get_item_count', {
            title = _U('quantity')
          }, function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('lscartel:getLockerStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenPutLockerStocksMenu()
    ESX.TriggerServerCallback('lscartel:getPlayerInventory', function(inventory)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker_menu', {
        title    = _U('locker_inventory'),
        elements = elements
      }, function(data, menu)

        local itemName = data.current.value

        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'locker_menu_put_item_count', {
            title = _U('quantity')
          }, function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('lscartel:putLockerStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetWeaponMenu()
    ESX.TriggerServerCallback('lscartel:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_get_weapon', {
        ...
        ESX.TriggerServerCallback('lscartel:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_put_weapon', {
      ...
      ESX.TriggerServerCallback('lscartel:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
    end, function(data, menu)
      menu.close()
...
--[[function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'lscartel_shop', {
            title    = _U('shop'),
            elements = elements
        }, function(data, menu)
            TriggerServerEvent('lscartel:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end, function(data, menu)
            menu.close()
        end)
end]]
...
AddEventHandler('lscartel:hasEnteredMarker', function(zone)
...
AddEventHandler('lscartel:hasExitedMarker', function(zone)
    CurrentAction = nil
    ESX.UI.Menu.CloseAll()
end)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('lscartel:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('lscartel:hasExitedMarker', LastZone)
            end
        end
    end
end)
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  38) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'lscartel', vehicleProps)
          else
            if GetEntityModel(vehicle) == GetHashKey('rentalbus') then
              TriggerServerEvent('esx_service:disableService', 'lscartel')
            end
          end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'lscartel', function(data, menu)
    ...
    if IsControlJustReleased(0,  167) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'lscartel_actions') then
...
-----------------------
----- TELEPORTERS -----
--[[AddEventHandler('lscartel:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, 38) and isInPublicMarker then
          TriggerEvent('lscartel:teleportMarkers', position)
        end
