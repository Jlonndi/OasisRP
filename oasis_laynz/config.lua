...
Cfg.Grades = {
    ...
    {number = 2, label = 'General Manager'},
...
Cfg.MapBlip = {
    {
        Pos     	= {x = -798.29, y = -221.43, z = 37.08},
        Sprite  	= 595,
        Display	    = 4,
        Scale  	    = 0.75,
        Colour  	= 15,
        Name        = 'Switchin Laynz Exotics',
        OnlyHasJob  = false
    },
}
...
Translation = {
    ['en'] = {
        ...
        ['unknown_amount'] = '~r~Invalid amount!',
        ...
        ['you_applied3'] = 'x ~s~!',
        ['not_enough_money'] = 'There is ~r~not enough money~s~ in your society wallet!',
