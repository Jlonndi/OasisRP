...
Citizen.CreateThread(function()
	while ESX == nil do
		TriggerServerEvent('t1ger_deliveryjob:giveESX') --REUIRED FOR PROPER ENCRYPTION LOADING
		Citizen.Wait(10)
	end
...
RegisterNetEvent('t1ger_deliveryjob:getESX') --REUIRED FOR PROPER ENCRYPTION LOADING
AddEventHandler('t1ger_deliveryjob:getESX', function()
