...
cfg = {
	...
	degradingHealthSpeedFactor = 0,			-- Speed of slowly degrading health, but not failure. Value of 10 means that it will take about 0.25 second per health point, so degradation from 800 to 305 will take about 2 minutes of clean driving. Higher values means faster degradation
...
repairCfg = {
	mechanics = {	-- Auto Repair, Grand Senora Desert
