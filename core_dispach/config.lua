...
ShootingZones = { -- Zones where citizens shooting gives police an alert
	{coords = vector3(68.91,6557.27,29.87), radius = 200.0},
	{coords = vector3(-149.79,6346.40,31.54), radius = 200.0},
	{coords = vector3(-393.26,6134.14,31.24), radius = 200.0},
	{coords = vector3(-33.78,-1102.02,26.41), radius = 2700.0},
	{coords = vector3(-359.27,2632.10,44.50), radius = 200.0},
	{coords = vector3(1112.97,2686.82,39.38), radius = 175.0},
	{coords = vector3(1689.45,2592.82,45.65), radius = 300.0},
	{coords = vector3(1847.52,3811.95,32.82), radius = 400.0},
	{coords = vector3(1324.93,3592.30,34.56), radius = 400.0},
	{coords = vector3(1674.31,4810.54,42.01), radius = 400.0},
	{coords = vector3(-2199.08,3117.7,32.81), radius = 400.0},
	{coords = vector3(-2543.31,2321.66,33.06), radius = 100.0},
	{coords = vector3(-3226.34,807.15,19.27), radius = 650.0},
	{coords = vector3(-3014.60,66.57,19.27), radius = 350.0},
	{coords = vector3(-2248.48,267.82,174.61), radius = 400.0},
},
...
JobOne = {job = 'police', canRequestLocalBackup = true, canRequestOtherJobBackup = true, forwardCall = true, canRemoveCall = true, callCommand = "lspd", color = "blueunit", label = "Police", blipColor = 26 },
JobTwo = {job = 'ambulance', canRequestLocalBackup = true, canRequestOtherJobBackup = true, forwardCall = true, canRemoveCall = true, callCommand = "ems", color = "redunit", label = "EMS",  blipColor = 1 },
JobThree = {job = 'mechanic', canRequestLocalBackup = true, canRequestOtherJobBackup = true, forwardCall = true, canRemoveCall = true, callCommand = "mech", color = "grayunit", label = "Mech",  blipColor = 39 },
