--search for --Jack & Tobi-- to see notes on what I need added, I would like to have this script handle all of the necessary police notifications for everything
...
--Jack & Tobi--
-- add a notification for police when a street race is started and the starting point and ending point are sent to the police.
-- add a notification for humane labs as soon as the mission is started
