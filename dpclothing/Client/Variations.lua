...
Citizen.CreateThread(function()
	...
	-- Male Hair
	AddNewVariation("Hair", "Male", 39, 38, true)
	AddNewVariation("Hair", "Male", 25, 38, true)
	AddNewVariation("Hair", "Male", 31, 38, true)
	AddNewVariation("Hair", "Male", 33, 59, true)
	AddNewVariation("Hair", "Male", 34, 33, true)
	AddNewVariation("Hair", "Male", 38, 39, true)
	AddNewVariation("Hair", "Male", 59, 33, true)
	AddNewVariation("Hair", "Male", 33, 34, true)
	-- Female Hair
	AddNewVariation("Hair", "Female", 17, 68, true)
	AddNewVariation("Hair", "Female", 18, 55, true)
	AddNewVariation("Hair", "Female", 19, 38, true)
	AddNewVariation("Hair", "Female", 21, 28, true)
	AddNewVariation("Hair", "Female", 23, 24, true)
	AddNewVariation("Hair", "Female", 25, 38, true)
	AddNewVariation("Hair", "Female", 26, 56, true)
	AddNewVariation("Hair", "Female", 29, 68, true)
	AddNewVariation("Hair", "Female", 31, 36, true)
	AddNewVariation("Hair", "Female", 32, 35, true)
	AddNewVariation("Hair", "Female", 34, 39, true)
	AddNewVariation("Hair", "Female", 38, 25, true)
	AddNewVariation("Hair", "Female", 39, 34, true)
	AddNewVariation("Hair", "Female", 40, 44, true)
	AddNewVariation("Hair", "Female", 41, 51, true)
	AddNewVariation("Hair", "Female", 42, 55, true)
	AddNewVariation("Hair", "Female", 43, 57, true)
	AddNewVariation("Hair", "Female", 46, 56, true)
	AddNewVariation("Hair", "Female", 47, 81, true)
	AddNewVariation("Hair", "Female", 49, 25, true)
	AddNewVariation("Hair", "Female", 53, 55, true)
	AddNewVariation("Hair", "Female", 54, 38, true)
	AddNewVariation("Hair", "Female", 68, 17, true)
	AddNewVariation("Hair", "Female", 55, 18, true)
	AddNewVariation("Hair", "Female", 38, 19, true)
	AddNewVariation("Hair", "Female", 28, 21, true)
	AddNewVariation("Hair", "Female", 24, 23, true)
	AddNewVariation("Hair", "Female", 38, 25, true)
	AddNewVariation("Hair", "Female", 56, 26, true)
	AddNewVariation("Hair", "Female", 28, 29, true)
	AddNewVariation("Hair", "Female", 36, 31, true)
	AddNewVariation("Hair", "Female", 35, 32, true)
	AddNewVariation("Hair", "Female", 39, 34, true)
	AddNewVariation("Hair", "Female", 25, 38, true)
	AddNewVariation("Hair", "Female", 34, 39, true)
	AddNewVariation("Hair", "Female", 44, 40, true)
	AddNewVariation("Hair", "Female", 51, 41, true)
	AddNewVariation("Hair", "Female", 55, 42, true)
	AddNewVariation("Hair", "Female", 57, 43, true)
	AddNewVariation("Hair", "Female", 81, 47, true)
	AddNewVariation("Hair", "Female", 25, 49, true)
	AddNewVariation("Hair", "Female", 55, 53, true)
	AddNewVariation("Hair", "Female", 38, 54, true)
	-- Male Top/Jacket Variations
	AddNewVariation("Jackets", "Male", 29, 55)
