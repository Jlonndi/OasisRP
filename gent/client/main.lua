...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'gent' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'gent', vehicleProps)
        end, function(data, menu)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gent_actions', {
      title    = _U('gent'),
      align    = 'top-left',
      elements = elements
    }, function(data, menu)
      ...
      --[[if data.current.value == 'menu_crafting' then
          ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'menu_crafting', {
                ...
                TriggerServerEvent('gent:craftingCoktails', data2.current.value)
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_gent', _U('billing'), amount)
        end
      else
...
function OpenGetStocksMenu()
  ESX.TriggerServerCallback('gent:getStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('gent:getStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenPutStocksMenu()
    ESX.TriggerServerCallback('gent:getPlayerInventory', function(inventory)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('gent:putStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetLockerStocksMenu()
  ESX.TriggerServerCallback('gent:getLockerStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'locker_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('gent:getLockerStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'locker_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('gent:putLockerStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetWeaponMenu()
    ESX.TriggerServerCallback('gent:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_get_weapon', {
        ...
        ESX.TriggerServerCallback('gent:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_put_weapon', {
      ...
      ESX.TriggerServerCallback('gent:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
    end, function(data, menu)
      menu.close()
...
--[[function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gent_shop', {
            title    = _U('shop'),
            elements = elements
        }, function(data, menu)
            TriggerServerEvent('gent:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end, function(data, menu)
            menu.close()
        end)
end]]
...
AddEventHandler('gent:hasEnteredMarker', function(zone)
...
AddEventHandler('gent:hasExitedMarker', function(zone)
    CurrentAction = nil
    ESX.UI.Menu.CloseAll()
end)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('gent:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('gent:hasExitedMarker', LastZone)
            end
        end
    end
end)
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  38) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'gent', vehicleProps)
          else
            if GetEntityModel(vehicle) == GetHashKey('rentalbus') then
              TriggerServerEvent('esx_service:disableService', 'gent')
            end
          end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'gent', function(data, menu)
    ...
    if IsControlJustReleased(0,  167) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'gent_actions') then
...
-----------------------
----- TELEPORTERS -----
--[[AddEventHandler('gent:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, 38) and isInPublicMarker then
          TriggerEvent('gent:teleportMarkers', position)
        end
