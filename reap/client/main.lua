...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'reap' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'reap', vehicleProps)
        end, function(data, menu)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reap_actions', {
      title    = _U('reap'),
      align    = 'top-left',
      elements = elements
    }, function(data, menu)
      ...
      --[[if data.current.value == 'menu_crafting' then
          ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'menu_crafting', {
                ...
                TriggerServerEvent('reap:craftingCoktails', data2.current.value)
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_reap', _U('billing'), amount)
        end
      else
...
function OpenGetStocksMenu()
  ESX.TriggerServerCallback('reap:getStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('reap:getStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenPutStocksMenu()
    ESX.TriggerServerCallback('reap:getPlayerInventory', function(inventory)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('reap:putStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetLockerStocksMenu()
  ESX.TriggerServerCallback('reap:getLockerStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'locker_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('reap:getLockerStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'locker_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('reap:putLockerStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetWeaponMenu()
    ESX.TriggerServerCallback('reap:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_get_weapon', {
        ...
        ESX.TriggerServerCallback('reap:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_put_weapon', {
      ...
      ESX.TriggerServerCallback('reap:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
    end, function(data, menu)
      menu.close()
...
--[[function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reap_shop', {
            title    = _U('shop'),
            elements = elements
        }, function(data, menu)
            TriggerServerEvent('reap:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end, function(data, menu)
            menu.close()
        end)
end]]
...
AddEventHandler('reap:hasEnteredMarker', function(zone)
...
AddEventHandler('reap:hasExitedMarker', function(zone)
    CurrentAction = nil
    ESX.UI.Menu.CloseAll()
end)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('reap:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('reap:hasExitedMarker', LastZone)
            end
        end
    end
end)
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  38) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'reap', vehicleProps)
          else
            if GetEntityModel(vehicle) == GetHashKey('rentalbus') then
              TriggerServerEvent('esx_service:disableService', 'reap')
            end
          end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'reap', function(data, menu)
    ...
    if IsControlJustReleased(0,  167) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'reap_actions') then
...
-----------------------
----- TELEPORTERS -----
--[[AddEventHandler('reap:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, 38) and isInPublicMarker then
          TriggerEvent('reap:teleportMarkers', position)
        end
