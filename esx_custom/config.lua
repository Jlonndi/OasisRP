...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = 111.03, y = 6626.59, z = 31.79},
	...
	ls2 = {
		Pos   = { x = 1174.77, y = 2640.46, z = 37.34},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = 731.09, y = -1087.29, z = 21.75 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls5 = {
		Pos   = { x = -1155.13, y = -2006.73, z = 12.68 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
