...
Config.Zones = {
  MechanicActions = {
    Pos   = {  x = -324.05, y = -1000.76, z = 29.47 },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -322.58, y = -994.20, z = 30.34, heading = 248.02 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -30.7, y = -1676.55, z = -28.61 },
