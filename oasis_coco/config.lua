...
Cfg.Coords = {
  ...
  Clothe = {
    {x = 271.38, y = -1164.98, z = 29.27}
  },

  Boss = {
    {x = 277.67, y = -1150.80, z = -29.27}
  },

  Garage = {
    {x = 274.41, y = -1161.71, z = 29.27, rot = 32.07, spawn = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50}}
  },

  DeSpawn = {
    {x = 277.39, y = -1158.37, z = 29.27}
  },

  Ring = {
    {x = 286.71, y = -1147.50, z = 29.25}
  },

  Computer = {
    {x = 288.86, y = -1165.19, z = 29.27, spawn = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50}}
  },
  
  Showrooms = {
      {
          spawn = {x = 302.79, y = -1152.50, z = 28.99, rot = 182.41},   --1
          menu = {x = 301.03, y = -1152.56, z = 29.30},
          ChangeColor = true,
          spawn2 = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50},
      },
      {
          spawn = {x = 300.11, y = -1157.08, z = 28.99, rot = 91.36},   --2
          menu = {x = 299.97, y = -1155.51, z = 29.30},
          ChangeColor = true,
          spawn2 = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50},
      },
      {
          spawn = {x = 297.40, y = -1152.47, z = 28.99, rot = 23.65},   --3
          menu = {x = 295.87, y = -1153.13, z = 29.30},
          ChangeColor = true,
          spawn2 = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50},
      },
      {
          spawn = {x = 294.05, y = -1150.97, z = 28.78, rot = 167.21},   --4
          menu = {x = 293.76, y = -1152.89, z = 29.27},
          ChangeColor = true,
          spawn2 = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50},
      },
      {
          spawn = {x = 291.60, y = -1150.79, z = 28.78, rot = 161.95},   --5
          menu = {x = 291.31, y = -1152.27, z = 29.27},
          ChangeColor = true,
          spawn2 = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50},
      },
      {
          spawn = {x = 289.14, y = -1150.72, z = 28.78, rot = 163.57},  --6
          menu = {x = 288.64, y = -1152.49, z = 29.27},
          ChangeColor = true,
          spawn2 = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50},
      },
      {
          spawn = {x = 293.79, y = -1158.07, z = 28.82, rot = 21.68}, --7
          menu = {x = 293.43, y = -1156.77, z = 29.27},
          ChangeColor = true,
          spawn2 = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50},
      },
      {
          spawn = {x = 291.24, y = -1158.91, z = 28.82, rot = 18.40}, --8
          menu = {x = 290.60, y = -1157.13, z = 29.27},
          ChangeColor = true,
          spawn2 = {x = 284.95, y = -1157.57, z = 29.27, rot = 90.50},
      },
  }
...
Cfg.MapBlip = {
  {
      Pos     	= {x = 288.77, y = -1160.22, z = 31.50},
      Sprite  	= 522,
      Display	    = 4,
      Scale  	    = 0.75,
      Colour  	= 21,
...
Translation = {
  ['en'] = {
      ['ring_infobar'] = 'Press ~b~E~s~ to notify a Cocomoto Salesperson',
