...
Citizen.CreateThread(function()
	while ESX == nil do
		TriggerServerEvent('t1ger_bankrobbery:giveESX') --REUIRED FOR PROPER ENCRYPTION LOADING
		Citizen.Wait(10)
	end
...
RegisterNetEvent('t1ger_bankrobbery:getESX') --REUIRED FOR PROPER ENCRYPTION LOADING
AddEventHandler('t1ger_bankrobbery:getESX', function()
...
AddEventHandler('t1ger_bankrobbery:PoliceNotifyBlip', function(targetCoords)
	if isCop and Config.AlertBlipShow then 
		...
		local dispachblip = targetCoords.x, targetCoords.y, targetCoords.z
