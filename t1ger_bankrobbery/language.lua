...
Lang = {
  ...
  -- Vault:
  ['close_vault_dr']          = '~r~[E]~s~ Close Vault Door',
  ['open_vault_dr']           = '~r~[E]~s~ Open Vault Door',
  ...
  -- Petty Cash:
  ['desk_cash_not_robbed']    = '~r~[G]~s~ Rob Petty Cash',
  ...
  -- ## PROGBARS ## --
  ['progbar_lockpicking']     = 'LOCKPICKING DOOR',
  ['progbar_open_powerbox']   = 'OPENING POWER BOX',
  ['progbar_cut_wires']       = 'CUTTING WIRES',
  ['progbar_rob_petty_cash']  = 'ROBBING PETTY CASH',
  ['progbar_cracking_safe']   = 'CRACKING SAFE',
}
