...
local carOnShow = GetHashKey('GODzLBHUR')
...
function showDiamondsOnScreenBaby()
	Citizen.CreateThread(function()
	  ...
	  --SetTvChannelPlaylist(2, "CASINO_DIA_PL", 0) -- diamonds
	  --SetTvChannelPlaylist(2, "CASINO_SNWFLK_PL", 0) -- snowflakes
	  --SetTvChannelPlaylist(2, "CASINO_WIN_PL", 0) -- win
	  SetTvChannelPlaylist(2, "CASINO_HLW_PL", 0) -- skull
	  SetTvChannel(2)
	  EnableMovieSubtitles(1)
  
	function doAlpha()
		Citizen.SetTimeout(timeout, function()
		--MUST MATCH ONE ABOVE
		--SetTvChannelPlaylist(2, "CASINO_DIA_PL", 0) -- diamonds
		--SetTvChannelPlaylist(2, "CASINO_SNWFLK_PL", 0)-- snowflakes
		--SetTvChannelPlaylist(2, "CASINO_WIN_PL", 0)-- win
		SetTvChannelPlaylist(2, "CASINO_HLW_PL", 0)-- skull
