...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'losb' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'losb', vehicleProps)
        end, function(data, menu)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'losb_actions', {
      title    = _U('losb'),
      align    = 'top-left',
      elements = elements
    }, function(data, menu)
      ...
      --[[if data.current.value == 'menu_crafting' then
          ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'menu_crafting', {
                ...
                TriggerServerEvent('losb:craftingCoktails', data2.current.value)
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_losb', _U('billing'), amount)
        end
      else
...
function OpenGetStocksMenu()
  ESX.TriggerServerCallback('losb:getStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('losb:getStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenPutStocksMenu()
    ESX.TriggerServerCallback('losb:getPlayerInventory', function(inventory)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('losb:putStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetLockerStocksMenu()
  ESX.TriggerServerCallback('losb:getLockerStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'locker_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('losb:getLockerStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'locker_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'locker_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('losb:putLockerStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetWeaponMenu()
    ESX.TriggerServerCallback('losb:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_get_weapon', {
        ...
        ESX.TriggerServerCallback('losb:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_put_weapon', {
      ...
      ESX.TriggerServerCallback('losb:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
    end, function(data, menu)
      menu.close()
...
--[[function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'losb_shop', {
            title    = _U('shop'),
            elements = elements
        }, function(data, menu)
            TriggerServerEvent('losb:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end, function(data, menu)
            menu.close()
        end)
end]]
...
AddEventHandler('losb:hasEnteredMarker', function(zone)
...
AddEventHandler('losb:hasExitedMarker', function(zone)
    CurrentAction = nil
    ESX.UI.Menu.CloseAll()
end)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('losb:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('losb:hasExitedMarker', LastZone)
            end
        end
    end
end)
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  38) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'losb', vehicleProps)
          else
            if GetEntityModel(vehicle) == GetHashKey('rentalbus') then
              TriggerServerEvent('esx_service:disableService', 'losb')
            end
          end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'losb', function(data, menu)
    ...
    if IsControlJustReleased(0,  167) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'losb_actions') then
...
-----------------------
----- TELEPORTERS -----
--[[AddEventHandler('losb:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, 38) and isInPublicMarker then
          TriggerEvent('losb:teleportMarkers', position)
        end
