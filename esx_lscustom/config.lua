...
Config.Zones = {
	--Coul Reapers Customs
	ls2 = {
		Pos   = { x = 1755.31, y = 3336.81, z = 40.71},
	...
	--cocomoto
	ls3 = {
		Pos   = { x = 271.59, y = -1166.66, z = 28.82},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	--gsc
	ls4 = {
		Pos   = { x = -128.38, y = -1791.49, z = 24.13},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	--vegas
     ls8 = {
		Pos   = { x = -198.58, y = -1324.28, z = 31.13 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {2.511, 5.123, 7.673, 10.314}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.325, 3.65, 5.3, 6.975}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {5.975, 7.666, 9.815}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {2.86, 4.72, 5.44, 6.885, 7.1}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {8.76, 11.32, 17.17, 20.32, 25.23, 31.17}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
