...
EvidenceReportInformationBullet = "firstname", -- The information displayd from users table in mysql in the evidence report (ONLY CHANGE IF YOU KNOW WHAT ARE YOU DOING)
...
EvidenceAlanysisLocation = vector3(485.63,-989.98,30.69), -- The place where the evidence will be analyzed and report generated
...
EvidenceStorageLocation = vector3(480.9,-984.66,30.69), -- The place where all evidence are being archived! You can view old evidence or delete it
--
